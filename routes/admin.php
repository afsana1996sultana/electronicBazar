...
use App\Http\Controllers\Admin\PCBuildingController;
...
use App\Http\Controllers\Backend\EmiContentController;
...
Route::prefix('admin')->middleware('admin')->group(function(){
	...
	//==============PC Building=====================
	Route::prefix('pc-buildings')->name('pc-building.')->group(function(){
		Route::get('/',[PCBuildingController::class,'index'])->name('index');
		Route::get('/create',[PCBuildingController::class,'create'])->name('create');
		Route::post('/store',[PCBuildingController::class,'store'])->name('store');
		Route::get('/edit/{id}',[PCBuildingController::class,'edit'])->name('edit');
		Route::post('/update/{id}',[PCBuildingController::class,'update'])->name('update');
		Route::get('/delete/{id}',[PCBuildingController::class,'delete'])->name('delete');
		Route::get('/active/{id}', [PCBuildingController::class, 'active'])->name('active');
		Route::get('/inactive/{id}', [PCBuildingController::class, 'inactive'])->name('in_active');
	});
	...
	Route::prefix('product')->group(function(){
		...
		Route::get('/get-specs-by-category/{id}', [ProductController::class, 'getSpecsByCategory'])->name('product.getSpecs');
	...
	Route::get('/customer/view/{id}', [UserController::class, 'view'])->name('customer.view');
	Route::get('/customer/delete/{id}', [UserController::class, 'destroy'])->name('customer.delete');
	Route::get('/customer_active/{id}', [UserController::class, 'active'])->name('customer.active');
	Route::get('/customer_inactive/{id}', [UserController::class, 'inactive'])->name('customer.in_active');
	...
	// Specifications All Route
	Route::resource('/specifications', SpecController::class);
	Route::get('/specifications/delete/{id}', [SpecController::class, 'destroy'])->name('spec.delete');

	Route::get('/spec_status_change/{id}', [SpecController::class, 'changeStatus'])->name('spec.changeStatus');
	Route::get('/spec_feature_status_change/{id}', [SpecController::class, 'changeFeatureStatus'])->name('spec.changeFeatureStatus');

	// SpecificationValue All Route
	Route::post('/specification/value', [SpecController::class, 'value_store'])->name('spec.value_store');
	Route::get('/specification_value_active/{id}', [SpecController::class, 'value_active'])->name('spec_value.active');
	Route::get('/specification_value_inactive/{id}', [SpecController::class, 'value_inactive'])->name('spec_value.in_active');
	Route::get('/specification/value/delete/{id}', [SpecController::class, 'value_destroy'])->name('spec_value.delete');

	// Warranty
	Route::resource('/warranty', WarrantyController::class);
	Route::get('/warranty/delete/{id}', [WarrantyController::class, 'destroy'])->name('warranty.delete');
	...
	Route::prefix('orders')->group(function () {
        ...
        Route::get('/all_orders/pos-sale-list', [OrderController::class, 'index2'])->name('all_orders.pos_sale_index');
    ...
    Route::prefix('pos')->group(function(){
		...
		Route::get('/pos/cart/update-quantity', [PosController::class, 'updatePosCartQuantity'])->name('pos.cart.update.quantity');
		Route::get('/pos/cart/insert-serial', [PosController::class, 'insertPosCartSerial'])->name('pos.cart.insert.serial');
		Route::get('/barcode/addto/cart',[PosController::class, 'pos_barcode_addtocart'])->name('pos.barcode.addtocart');
	});
    //emiContent
    Route::resource('/emiContent', EmiContentController::class);
