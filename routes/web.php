...
// Route::match(['get', 'post'], '/product/search', 'App\Http\Controllers\Frontend\FrontendController@productSearch')->name('product.search');
/* =============== Advance Search ============= */
...
Route::get('/pc-building',[FrontendController::class,'pcBuilding'])->name('pc_building');
Route::get('/sharePdfPage',[FrontendController::class,'sharePdfPage'])->name('sharePdfPage');
// Page Setting
...
//brand page
Route::get('/brand/show',[FrontendController::class,'brand_show'])->name('brand.show');
...
/* ============ Start PC Cart  Data Withn Ajax  ============= */
Route::post('/pc/cart/data/store/{id}',[CartController::class, 'PcAddToCart'])->name('pc.cart.add');
Route::get('/pc/update/cart',[CartController::class, 'PcUpdateCart'])->name('pc.update.cart');
Route::get('/pc/get/cart',[CartController::class, 'PcgetCart'])->name('pc.update.cart');
Route::get('/pc/cart/delete/{id}',[CartController::class, 'PcCartdelete'])->name('pc.cart.delete');
Route::get('/add/pc/main/cart',[CartController::class, 'addPcMainCart'])->name('add.Pc.Main.Cart');
/* ============ End  PC Cart  Data Withn Ajax  ============= */
...
// wishList
Route::get('/add/product-wishlist/{id}',[WishListController::class,'add_wishlist'])->name('add.wishlist');
Route::get('/list/wishlist',[WishListController::class,'listViewWistList'])->name('listViewWistList');
Route::get('/wish/count',[WishListController::class,'getWishCount'])->name('get.Wish.Count');
Route::get('wishlist/remove/{id}', [WishListController::class,'removeFromwishList'])->name('removeWishitem');

// CompareList
Route::get('/add/product-comaparelist/{id}',[CompareController::class,'add_comparelist'])->name('add.comparelist');
Route::get('/list/comparelist',[CompareController::class,'listViewCompareList'])->name('listView.CompareList');
Route::get('/compare/count',[CompareController::class,'getcompareCount'])->name('get.compare.Count');
Route::get('comparelist/remove/{id}', [CompareController::class,'removeFromCompareList'])->name('remove.Compareitem');

//emicontent
Route::get('emi-information', [FrontendController::class,'emi_information'])->name('emi.information');
//wholesell price
Route::get('/wholesell/price', [ProductController::class, 'wholesell_price'])->name('wholesell.price');

//review
Route::post('/review/store',[ReviewController::class,'store'])->name('review.store');

//Invoice Download
Route::get('/customer-invoice/{id}', [OrderController::class, 'customer_invoice_download'])->name('customer.invoice.download');
