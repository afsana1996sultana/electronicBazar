...
<body>
    ...
    <script type="text/javascript">
        ...
        function selectAttributeModal(id, position) {
            //const cleanedId = id.replace(/[^\w\s]/gi, '_');
            //const idArray = cleanedId.split(/_+/).filter(Boolean);
                ...
                success: function(data) {
                    ...
                    if (data.product.discount_price > 0) {
                        if (data.product.discount_type == 1) {
                            ...
                            $('.current-price').text(data.product.regular_price - discount);
                        ...
                        $('.current-price').text(data.product.regular_price);
                        $('#oldprice').text('');
    ...
    <script type="text/javascript">
                            ...
                            rows += `</td>
                                ...
                                <td class="text-center detail-info">
                                    <div class="detail-extralink mr-15">
                                        ...
                                        <input type="text" value="${value.qty}" min="1" max="100" disabled="" style="text-align: center; padding-left:0px;">
        ...
        function listOfWishlist() {
            $.ajax({
                type: "get",
                url: "list/wishlist",
                success: function(response) {
                    $('.wishlistdata').html(response.wish_data)
                }
            })
        }
        listOfWishlist()
        ...
        function wishCount() {
            $.ajax({
                ...
                url: "/wish/count",
                success: function(response) {
                    $('.wish-count').text(response.wish_count)
                }
            })
        }
        wishCount()
        /* ============= Start Product Comparelist========== */
        function listOfComparelist() {
            $.ajax({
                type: "get",
                url: "list/comparelist",
                success: function(response) {
                    $('.comparelistdata').html(response.compare_data)
                }
            })
        }
        listOfComparelist()
        ...
        function addComparelist(id) {
            $.ajax({
                type: "get",
                url: '/add/product-comaparelist/' + id,
                success: function(response) {
                    compareCount()
                    let Toast = Swal.mixin({
                        toast: true,
    ...
    <script>
        ...
        chatbox.setAttribute("page_id", "169136336281347");
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(Object.keys(data).length > 0){
                        html += `<div class="container mt-5 main-search-box">
                                        <div class="row">`;
                                        $.each(data, function(key,value){
                                            ...
                                            html += `<div class="col-md-12">
                                                        <div class="card">`;
                                            html +=                 `<a href="${base_url}/product-details/${slug}">`;
                                                                        if(key.index == (length.data - 1)){
                                            html +=                         `<div class="list">
                                                                                <img src="/${value.product_thumbnail}" style="width: 30px; height: 30px;">
                                                                                <div class="d-flex flex-column ml-3" style="margin-left: 10px;"> <span style="color: black;">${value.name_en}</span>
                                                                                </div>
                                                                            </div>`;
                                                                        }else{
                        ...
                        html = '<h5 class="text-center text-danger p-4">Product Not Found </h5>'
                    }
