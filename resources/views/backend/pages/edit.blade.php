...
@section('admin')
    ...
    <section class="content-main">
        <div class="content-header">
            ...
            <div class="">
                <a href="{{ route('page.index') }}" class="btn btn-primary"><i class="material-icons md-plus"></i> Page
                    List</a>
            </div>
        </div>
                                ...
                                <form method="post" action="{{ route('page.update', $page->id) }}"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" id="name_bn" type="text" name="name_bn"
                                            placeholder="Write page name bangla" value="{{ $page->name_bn }}">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" id="title" type="text" name="title"
                                            placeholder="Write page title" value="{{ $page->title }}">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="description_en" id="description_en" cols="5" placeholder="Write page description english"
                                            class="form-control summernote">{{ $page->description_en }}</textarea>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="description_bn" id="description_bn" cols="5" placeholder="Write page description bangla"
                                            class="form-control summernote">{{ $page->description_bn }}</textarea>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="custom_select">
                                            <select class="form-control select-active w-100" name="position">
                                                <option value="Nav" @if ($page->position == 'Nav') selected @endif>Nav
                                                </option>
                                                <option value="Bottom" @if ($page->position == 'Bottom') selected @endif>
                                                    Bottom</option>
                                                <option value="Both" @if ($page->position == 'Both') selected @endif>
                                                    Both</option>
                                            </select>
                                            @error('position')
                                                <p class="text-danger">{{ $message }}</p>
                                    ...
                                    <div class="mb-4">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="form-check-input me-2 cursor" name="status"
                                                id="status" value="1" {{ $page->status == 1 ? 'checked' : '' }}>
