            ...
            <div class="table-responsive-sm">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <form method="post" action="{{ route('pc-building.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4">
                                   <label for="name" class="col-form-label col-md-2" style="font-weight: bold;"> Name</label>
                                <input class="form-control" id="name" type="text" name="name" placeholder="Write Name" value="{{old('name')}}">
                                @error('name')
                            ...
                            <div class="mb-4">
                                ...
                                <input class="form-control" id="priority" type="text" name="priority" placeholder="Write priority" value="{{old('name')}}">
                                @error('priority')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                              ...
                              <textarea name="description" id="description" cols="5" placeholder="Write description" class="form-control">{{old('description_bn')}}</textarea>
                            </div>
