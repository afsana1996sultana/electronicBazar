...
<section class="content-main">
    <div class="content-header">
        ...
        <div class="">
            <a href="{{ route('brand.all') }}" class="btn btn-primary"><i class="material-icons md-plus"></i> Brand List</a>
        </div>
    </div>
                        ...
                        <div class="col-md-12">
                            <form method="post" action="{{ route('brand.update',$brand->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" id="name_en" type="text" name="name_en" placeholder="Write brand name english" required="" value="{{ $brand->name_en }}">
                                    @error('name_en')
                                ...
                                <div class="mb-4">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="form-check-input me-2 cursor" name="top_brand" id="top_brand" value="1" {{ $brand->top_brand == 1 ? 'checked': '' }}>
                                        <label class="form-check-label cursor" for="top_brand">Top Brand</label>
                                    </div>
                                </div>
                                <div class="mb-4">
                                    <div class="custom-control custom-switch">
