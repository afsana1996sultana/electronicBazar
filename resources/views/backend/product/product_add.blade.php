...
@push('css')
    <style>
        ...
        .note-modal-footer .btn.btn-primary {
            border-radius: 5px;
            border: none;
            margin-bottom: 10px;
            padding: 5px 10px;
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="custom_select">
                                        <select class="form-control select-active w-100 form-select select-nice"
                                            name="category_id" id="product_category" value="{{ old('category_id') }}">
                                ...
                                <div class="col-md-6 mb-4">
                                    <a style="background-color: #3BB77E; " type="button" class="btn btn-sm float-end"
                                        id="closeModal1" data-bs-toggle="modal" data-bs-target="#brand"><i
                                            class="fa-solid fa-plus text-white"></i></a>
                                    <label for="brand_id" class="col-form-label" style="font-weight: bold;">Brand: <span
                                    ...
                                    @else
                                        <div class="col-md-6 mb-4">
                                            <label for="vendor_id" class="col-form-label"
                                                style="font-weight: bold;">Vendor: <span
                                                    class="text-danger">*</span></label>
                                            <div class="custom_select">
                                                <select class="form-control select-active w-100 form-select select-nice"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input class="form-control tags-input" type="text"name="tags[]"
                                        placeholder="Type and hit enter to add a tag" value="{{ old('tags[]') }}">
                                        ...
                                        <select class="form-control select-active w-100 form-select select-nice"
                                            ...
                                            @foreach ($attributes as $attribute)
                                                <option value="{{ $attribute->id }}"
                                                    {{ collect(old('choice_attributes'))->contains($attribute->id) ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input class="form-control" id="purchase_price" type="number" name="purchase_price"
                                        placeholder="Write product bying price" value="{{ old('purchase_price') }}">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input class="form-control" id="regular_price" type="number" name="regular_price"
                                        placeholder="Write product regular price" min="0"
                                        ...
                                        <select class="form-control select-active w-100 form-select select-nice"
                                            ...
                                            @foreach ($warranties as $warranty)
                                                <option value="{{ $warranty->id }}"
                                                    {{ $warranty->id == old('warranty_id') ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <textarea name="short_description_en" rows="2" cols="2" class="form-control summernote"
                                        placeholder="Write Short Description English">{{ old('short_description_en') }}</textarea>
                                </div>
                                <div class="col-md-6 mb-4">
                                    ...
                                    <textarea name="short_description_bn" id="short_description_bn" rows="2" cols="2"
                                        class="form-control summernote" placeholder="Write Short Description Bangla">{{ old('short_description_bn') }}</textarea>
                                </div>
                                <!-- Description End -->
                            </div>
                            <div class="row">
                                <!-- Description Start -->
                                <div class="col-md-6 mb-4">
                                    <label for="long_descp_en" class="col-form-label" style="font-weight: bold;">Long
                                        Description (En): <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mb-4">
                                    <label for="long_descp_bn" class="col-form-label" style="font-weight: bold;">Long
                                        Description (Bn):</label>
                                    <textarea name="description_bn" id="long_descp_bn" rows="2" cols="2" class="form-control summernote"
                                        placeholder="Write Long Description Bangla">{{ old('long_descp_bn') }}</textarea>
                                </div>
                                <!-- Description End -->
                            </div>
                        </div>
                            ...
                            if (Object.keys(data).length > 0) {
                                $.each(data, function(key, value) {
                                    ...
                                    $.each(value.spec_values, function(key, spec_value) {
                                        html +=
                                            `<option value="${spec_value.value}_${spec_value.id}">${spec_value.value}</option>`;
                                    });
                                    html += `</select>
											</div>
										</div>
