                        ...
                        <div class="col-md-3">
                            ...
                            <div class="dashboard-menu">
                                <ul class="nav flex-column" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="comparelist-tab" data-bs-toggle="tab" href="#comparelist" role="tab" aria-controls="comparelist" aria-selected="false"><i class="fi-rs-shuffle mr-10"></i>CompareList</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="tab-content account dashboard-content pl-50">
                                ...
                                <div class="tab-pane fade" id="wishlist" role="tabpanel" aria-labelledby="wishlist-tab">
                                    <div class="card">
                                        ...
                                        <div class="card-body row wishlistdata">

                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="comparelist" role="tabpanel" aria-labelledby="comparelist-tab">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="mb-0">MY CompareList</h5>
                                        </div>
                                        <div class="card-body row comparelistdata">
