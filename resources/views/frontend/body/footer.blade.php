                        ...
                        <div class="col-sm-6 col-md-3 col-12">
                            <div class="footer-link-widget wow animate__animated animate__fadeInUp"
                                ...
                                <ul class="footer-list mb-sm-5 mb-md-0">
                                    ...
                                    <li><a href="{{ route('emi.information') }}">EMI</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3 col-12">
                            ...
                            <div class="footer-link-widget wow animate__animated animate__fadeInUp"
                                ...
                                <ul class="contact-infor">
                                    ...
                                    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}"
                                            ...
                                            href="tel:{{ get_setting('phone')->value ?? 'null' }}">{{
                                    ...
                                    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-email-2.svg') }}"
                                            ...
                                            href="mailto:{{ get_setting('email')->value ?? 'null' }}">{{
                                            get_setting('email')->value ?? 'null' }}</a>
                                    </li>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <p class="font-sm mb-0">
                        ...
                        &copy; {{ get_setting('copy_right')->value ?? 'null' }}
...
<div class="nest-mobile-bottom-nav d-xl-none mobile_fixed_bottom bg-white shadow-lg border-top rounded-top"
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col mobile_bottom_nav_col">
            <a href="{{ route('pc_building') }}" class="text-reset d-block text-center pb-2 pt-3">
                <span class="d-inline-block position-relative px-2">
                    <i class="fa-sharp fa-solid fa-bag-shopping {{ $route == 'product.show' ? 'text-brand' : '' }}"></i>
                </span>
                <span class="d-block fs-10 fw-600">PC Builder</span>
            </a>
        </div>
        <div class="col-auto">
