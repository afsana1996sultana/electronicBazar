        ...
        <div class="container mt-30 mb-30">
            <div class="row">
                <div class="col-lg-8 mb-40">
                    <h1 class="heading-2 mb-10 fs-2">Your Cart</h1>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="cart-action d-flex justify-content-between">
                        <a href="{{route('home')}}" class="btn continue__shopping"><i class="fi-rs-arrow-left mr-10"></i>Continue Shopping</a>
                ...
                <div class="col-lg-4">
                    <div class="border p-md-4 cart-totals">
                        ...
                        <a href="{{ route('checkout')}}" class="btn w-100 proceed__checkout">Proceed To CheckOut<i class="fi-rs-sign-out ml-15"></i></a>
                    </div>
                </div>
            </div>
        </div>
