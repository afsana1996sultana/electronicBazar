							...
							<div class="col-12 col-lg-12">
							   <div class="box box-widget widget-user">
							      ...
							      <div class="widget-user-image" style="    position: absolute; top: 128px; left: 50%;margin-left: 58px;">
							        <img class="" style="width: 100px; height: 100px; border-radius: 50%;" src="{{ (!empty($adminData->profile_image))? asset($adminData->profile_image):url('upload/no_image.jpg') }}" alt="User Avatar">
							      </div>
